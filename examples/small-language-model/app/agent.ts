 ...
 * For a stricter requirements, we could fine-tune SLM to provide better results, but we want to demonstrate that even the base model can be useful without fine-tuning.
 *
 * note: tool calling is not supported.
 * note2: SLM also is not very good at following instructions, it wont always respect the "TL;DR:" requirement.
 */
