...
const config: AixyzConfig = {
  name: "Unit Conversion Agent (Local LLM)",
  description:
    "AI agent that converts values between metric, imperial, and other measurement systems — powered by a local LLM running in-process via WebAssembly (no API key required).",
  version: "0.1.0",
  x402: {
