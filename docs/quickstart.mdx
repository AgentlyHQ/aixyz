...
<AccordionGroup>
  <Accordion icon="copy" title="Clone your docs locally">
    ...
    one. You can find a link to this repository in your [dashboard](https://dashboard.mintlify.com).

    To clone the repository locally so that you can make and preview changes to your docs, follow the [Cloning a
