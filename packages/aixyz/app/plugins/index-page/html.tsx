  ...
  return (
    <nav class="flex items-center justify-between h-14 border-b border-border">
      <div class="flex items-center gap-3">
        <div class="w-7 h-7 rounded-lg bg-primary flex items-center justify-center shadow-sm shadow-primary/25">
          <svg viewBox="0 0 20 20" fill="none" class="w-3.5 h-3.5 text-white">
            <path d="M10 1L1 5.5l9 4.5 9-4.5L10 1z" fill="currentColor" opacity="0.5" />
            <path
