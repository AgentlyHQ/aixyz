...
- Next.js 15.2.9: Latest stable with all security patches (fixes DoS, RCE, cache poisoning, and authorization bypass vulnerabilities)
...
**2026-02-19**: Updated Next.js to 15.2.9 to patch all known vulnerabilities:
